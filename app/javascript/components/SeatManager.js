    ...
    >
      ...
      <Row>
        <Col span={8} offset={8}>
          {state.response[0] &&
            <div>
              <Typography.Title {...tailLayout} level={5}>Best Seats are: <b>{state.response[0].id}</b></Typography.Title>
              <Typography.Title {...tailLayout} level={5}>Also some good available Seats are</Typography.Title>
